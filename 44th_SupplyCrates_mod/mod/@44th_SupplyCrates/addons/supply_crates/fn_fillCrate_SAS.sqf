...
_crate addWeaponCargoGlobal ["UK3CB_BAF_NLAW_Launcher",     3];
...
_crate addMagazineCargoGlobal ["MCC_PMAG_556_556_30_MK262_NAS3",           60];
...
_crate addMagazineCargoGlobal ["UK3CB_BAF_SmokeShell",                     20];
_crate addMagazineCargoGlobal ["UK3CB_BAF_SmokeShellGreen",                 4];
_crate addMagazineCargoGlobal ["UK3CB_BAF_SmokeShellRed",                   4];
...
_crate addMagazineCargoGlobal ["rhs_mag_m67",                              24];
_crate addMagazineCargoGlobal ["ACE_CTS9",                                 12];
_crate addMagazineCargoGlobal ["MCC_ICM_6ARC_20RD_ATIP",                   12];
_crate addMagazineCargoGlobal ["MCC_ICM_6ARC_20RD_ADVAP",                   6];
_crate addMagazineCargoGlobal ["rhsusf_m112_mag",                          10];
...
_crate addMagazineCargoGlobal ["rhsusf_200Rnd_556x45_soft_pouch_coyote",    1];
_crate addMagazineCargoGlobal ["rhsusf_200Rnd_556x45_mixed_soft_pouch_coyote", 2];
_crate addMagazineCargoGlobal ["rhsusf_100Rnd_556x45_M995_soft_pouch_coyote",  2];
...
_crate addItemCargoGlobal ["G_Blindfold_01_black_F",            5];
_crate addItemCargoGlobal ["tsp_lockpick",                      2];
_crate addItemCargoGlobal ["kat_sealant",                       5];
